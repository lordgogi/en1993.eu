<template>
  <div>
    <CrossSectionsHelper>
      ...
      <div slot="title">Cross Section Properties - T-profile stiffened plate-Section</div>
      <div slot="subtitle">Calculator calculates Cross-Sectional properties - both elastic and plastic of Plate stiffenned with T-profile</div>
      ...
      <div slot="picture">
        <img alt="Cross Section Plate stiffened with T-shape" src="../../assets/legend-t-stiff.png">
      </div>
